...
var _ = g.Describe("[Feature:Platform] OLM should", func() {
	...
	g.It("OLM-Medium-OCP-20981-contain the source commit id [Serial]", func() {
		sameCommit := ""
...
var _ = g.Describe("[sig-operator] an end user handle OLM common object", func() {
	...
	g.It("OLM-Medium-OCP-24904-create catalogsource with grpc address", func() {
		var (
			itName = g.CurrentGinkgoTestDescription().TestText
	...
	g.It("OLM-Medium-OCP-24076-check the version of olm operator is appropriate in ClusterOperator", func() {
		var (
	...
	g.It("OLM-Medium-OCP-21825-Certs for packageserver can be rotated successfully", func() {
		var (
	...
	g.It("OLM-Low-OCP-26002-allow pod of operator source on master", func() {
		var (
	...
	g.It("OLM-Medium-OCP-24094-Default resources of Marketplace operator", func() {
		var (
			cl = checkList{}
		)
	...
	g.It("OLM-Medium-OCP-24093-check the delete of operatorsource", func() {
		var (
			itName = g.CurrentGinkgoTestDescription().TestText
			osrc   = operatorSourceDescription{
				name:              "opsrctestolm",
...
var _ = g.Describe("[sig-operator] an end user handle OLM within a namespace", func() {
	...
	g.It("OLM-Medium-OCP-23170-API labels should be hash", func() {
		var (
			itName = g.CurrentGinkgoTestDescription().TestText
			og     = ogD
			sub    = subD
	...
	g.It("OLM-Medium-OCP-20979-only one IP is generated", func() {
		var (
			itName = g.CurrentGinkgoTestDescription().TestText
			og     = ogD
			sub    = subD
	...
	g.It("OLM-Medium-OCP-25757-High-OCP-22656-manual approval strategy apply to subsequent releases", func() {
		var (
			itName = g.CurrentGinkgoTestDescription().TestText
			og     = ogD
			sub    = subD
	...
	g.It("OLM-Medium-OCP-24438-check subscription CatalogSource Status", func() {
		var (
			itName = g.CurrentGinkgoTestDescription().TestText
			catsrc = catalogSourceDescription{
	...
	g.It("OLM-Medium-OCP-24027-can create and delete catalogsource and sub repeatedly", func() {
		var (
			itName = g.CurrentGinkgoTestDescription().TestText
			catsrc = catalogSourceDescription{
				name:        "catsrc-test-operator",
	...
	g.It("OLM-High-OCP-24870-can not create csv without operator group", func() {
		var (
			itName = g.CurrentGinkgoTestDescription().TestText
			og     = ogD
			sub    = subD
	...
	g.It("OLM-Medium-OCP-21404-csv will be RequirementsNotMet after sa is delete", func() {
		var (
			itName = g.CurrentGinkgoTestDescription().TestText
			og     = ogD
			sub    = subD
	...
	// It will cover part of test case: OCP-21404, author: kuiwang@redhat.com
	g.It("OLM-Medium-OCP-21404-csv will be RequirementsNotMet after role rule is delete", func() {
		var (
			itName = g.CurrentGinkgoTestDescription().TestText
			og     = ogD
			sub    = subD
	...
	g.It("OLM-High-OCP-25855-Add the channel field to subscription_sync_count", func() {
		var (
			itName = g.CurrentGinkgoTestDescription().TestText
			og     = ogD
			sub    = subD
...
var _ = g.Describe("[sig-operator] an end user handle OLM to support", func() {
	...
	g.It("OLM-High-OCP-22226-the csv without support AllNamespaces fails for og with allnamespace", func() {
		var (
			itName = g.CurrentGinkgoTestDescription().TestText
	...
	// It will cover part of test case: OCP-22226, author: kuiwang@redhat.com
	g.It("OLM-High-OCP-22226-the csv without support MultiNamespace fails for og with MultiNamespace", func() {
		var (
			itName = g.CurrentGinkgoTestDescription().TestText
			og     = operatorGroupDescription{
	...
	g.It("OLM-Medium-OCP-22200-add minimum kube version to CSV", func() {
		var (
			itName = g.CurrentGinkgoTestDescription().TestText
			og     = operatorGroupDescription{
				name:      "og-singlenamespace",
	...
	g.It("OLM-Medium-OCP-23473-permit z-stream releases skipping during operator updates", func() {
		var (
			itName = g.CurrentGinkgoTestDescription().TestText
			og     = operatorGroupDescription{
				name:      "og-singlenamespace",
	...
	g.It("OLM-Medium-OCP-24664-CRD updates if new schemas are backwards compatible", func() {
		var (
			itName = g.CurrentGinkgoTestDescription().TestText
			og     = operatorGroupDescription{
				name:      "og-singlenamespace",
	...
	g.It("OLM-Medium-OCP-21824-verify CRD should be ready before installing the operator", func() {
		var (
			itName = g.CurrentGinkgoTestDescription().TestText
			og     = operatorGroupDescription{
				name:      "og-singlenamespace",
...
var _ = g.Describe("[sig-operator] an end user handle OLM within all namespace", func() {
	...
	g.It("OLM-Medium-OCP-21484-High-OCP-21532-watch special or all namespace by operator group", func() {
		var (
			itName = g.CurrentGinkgoTestDescription().TestText
	...
	g.It("OLM-High-OCP-25679-Medium-OCP-21418-Cluster resource created and deleted correctly", func() {
		var (
			itName = g.CurrentGinkgoTestDescription().TestText
			sub    = subscriptionDescription{
	...
	g.It("OLM-Medium-OCP-24906-Operators requesting cluster-scoped permission can trigger kube GC bug", func() {
		var (
			itName = g.CurrentGinkgoTestDescription().TestText
			sub    = subscriptionDescription{
				name:                   "amq-streams",
	...
	g.It("OLM-High-OCP-25783-Subscriptions are not getting processed taking very long to get processed [Serial]", func() {
		var (
			itName           = g.CurrentGinkgoTestDescription().TestText
