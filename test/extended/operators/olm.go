...
var _ = g.Describe("[Feature:Platform] an end user use OLM", func() {
	...
	//  do not use ipv4 addresses in CatalogSources generated by marketplace
	// author: tbuskey@redhat.com
	g.It("OCP-27589-High-do not use ipv4 addresses in CatalogSources generated by marketplace", func() {
		re := regexp.MustCompile(`(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)(\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)){3}`)
		olmErrs := 0
		olmNames := []string{""}
		olmNamespace := "openshift-marketplace"
